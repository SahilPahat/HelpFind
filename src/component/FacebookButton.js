...
export default class FacebookButton extends Component {
 ...
 //"user_friends", for android add in LoginManager
 //"user_friends", remove in ios

  goToHomePage = () => {

    this.props.data.navigation.navigate('HomeTab', { basicData : this.props.data.navigation.state.params.basicData });
  }
                      ...
                      (data) => {
                        AccessToken.getCurrentAccessToken().then((data) => {
                          ...
                          .then((json) => {
                            ...
                            var encodedString = Base64.encode(json.picture.data.url);
