...
class MyProfile extends Component {
  constructor(props) {
    ...
    AsyncStorage.getItem('selectedLanguage').then(value => {
      return (I18n.locale = JSON.parse(value));
    });
    ...
    this.state = {
      data: {
        ...
        data: [
          {
            user_email: 'cvinfotech@gmail.com',
            display_name: 'Cv Infotech',
          },
        ],
      },
        ...
        {this.state.data === '' ? null : (
          <ScrollView
                ...
                <View style={styles.headerColumn}>
                  ...
                  <Text style={styles.userNameText}>
                    {(this.state.data.data && this.state.data.data.length) > 0
                      ? this.state.data.data[0].display_name
                      : ''}
                  </Text>
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate('EditProfile', this.state.data)
                }
                style={{
                  flexDirection: 'row',
                  alignItems: 'center',
                ...
                <Text style={{marginLeft: 5}}>
                  {I18n.t('Profile.index.editLabel')}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            {/* <View style={styles.bodyContainer}>
              ...
              <Text style={styles.bodyLabel}>
                {I18n.t('Profile.index.NameTextLabel')}
              </Text>
            ...
            <View style={styles.bodyContainer}>
              ...
              />
              <Text style={styles.bodyLabel}>
                {I18n.t('Profile.index.EmailTextLabel')}
              </Text>
              <Text style={styles.bodyRight}>
                {(this.state.data.data && this.state.data.data.length) > 0
                  ? this.state.data.data[0].user_email
                  : ''}
              </Text>
            </View>
            <View style={styles.line} />
            ...
            <View style={styles.bodyContainer}>
              ...
              />
              <Text style={styles.bodyLabel}>
                {I18n.t('Profile.index.SelectedCityTextLabel')}
              </Text>
            ...
            <View style={styles.bodyContainer}>
              ...
              />
              <Text style={styles.bodyLabel}>
                {I18n.t('Profile.index.SelectedCountryTextLabel')}
              </Text>
              <Text style={styles.bodyRight}>
                {this.state.data.country === ''
                  ? this.state.data.country.value
            ...
            <View style={styles.bodyContainer}>
              ...
              />
              <Text style={styles.bodyLabel}>
                {I18n.t('Profile.index.logoutTextLabel')}
              </Text>
              <TouchableOpacity
                style={styles.button}
                onPress={() => this.onPressLogout()}>
                <Text style={styles.bodyRight}>
                  {I18n.t('Profile.index.logoutLabel')}
                </Text>
              </TouchableOpacity>
            </View>
            <View style={styles.line} />
